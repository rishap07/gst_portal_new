...
<link type="text/css" rel="stylesheet" href="<?php echo THEME_URL; ?>/css/bootstrap.min.css" />
...
<script type="text/javascript" src="<?php echo THEME_URL; ?>/js/jquery-3-2.js"></script>
...
<div class="mobileheader shadow">
 	 <div class="col-sm-4 col-xs-6 moblogo" style="padding-left:0px;"><a href="#"><img src="image/mob-GST-logo.jpg" alt="#"></a></div>
            ...
            <ul class="nav" id="menu"> 
                ...
                <li>
                    ...
                    <ul class="nav nav-stacked collapse left-submenu" id="item2">
                          ...
                          <li><a href="<?php echo PROJECT_URL; ?>/?page=client_list"><i class="fa fa-circle" aria-hidden="true"></i>All Client</a></li>
                          <li><a href="<?php echo PROJECT_URL; ?>/?page=client_update"><i class="fa fa-circle" aria-hidden="true"></i>Add New Client</a></li>
                ...
                <li>
                    ...
                    <span class="collapse in hidden-xs">Master <span class="navrgtarrow"><i class="fa fa-chevron-right" aria-hidden="true"></i></span></span></a>
                     <ul class="nav nav-stacked collapse left-submenu" id="item4">
                                ...
                                <?php if ($db_obj->can_read('master_receiver')) { ?><li><a href="<?php echo PROJECT_URL; ?>/?page=master_receiver"><i class="fa fa-circle" aria-hidden="true"></i>Receiver</a></li><?php } ?>
                                <?php if ($db_obj->can_read('master_supplier')) { ?><li><a href="<?php echo PROJECT_URL; ?>/?page=master_supplier"><i class="fa fa-circle" aria-hidden="true"></i>Supplier</a></li><?php } ?>
                ...
                <li>
                    ...
                    <span class="collapse in hidden-xs">Invoices <span class="navrgtarrow"><i class="fa fa-chevron-right" aria-hidden="true"></i></span></span></a>
                     <ul class="nav nav-stacked collapse left-submenu" id="item5">

                                <?php if ($db_obj->can_read('client_invoice')) { ?><li><a href="<?php echo PROJECT_URL . '/?page=client_upload_invoice'; ?>"><i class="fa fa-circle" aria-hidden="true"></i>Upload Tax Invoice</a></li><?php } ?>
                                <?php if ($db_obj->can_read('client_invoice')) { ?><li><a href="<?php echo PROJECT_URL . '/?page=client_invoice_list'; ?>"><i class="fa fa-circle" aria-hidden="true"></i>All Tax Invoices</a></li><?php } ?>
                                ...
                                <?php if ($db_obj->can_read('client_invoice')) { ?><li><a href="<?php echo PROJECT_URL . '/?page=client_bill_of_supply_invoice_list'; ?>"><i class="fa fa-circle" aria-hidden="true"></i>All Bill Of Supply Invoice</a></li><?php } ?>
                                ...
                                <?php if ($db_obj->can_read('client_invoice')) { ?><li><a href="<?php echo PROJECT_URL . '/?page=client_receipt_voucher_invoice_list'; ?>"><i class="fa fa-circle" aria-hidden="true"></i>All Receipt Voucher Invoice</a></li><?php } ?>
                                ...
                                <?php if ($db_obj->can_read('client_invoice')) { ?><li><a href="<?php echo PROJECT_URL . '/?page=client_refund_voucher_invoice_list'; ?>"><i class="fa fa-circle" aria-hidden="true"></i>All Refund Voucher Invoice</a></li><?php } ?>
                                ...
                                <?php if ($db_obj->can_read('client_invoice')) { ?><li><a href="<?php echo PROJECT_URL . '/?page=client_payment_voucher_invoice_list'; ?>"><i class="fa fa-circle" aria-hidden="true"></i>All Payment Voucher Invoice</a></li><?php } ?>
                                ...
                                <?php if ($db_obj->can_read('client_invoice')) { ?><li><a href="<?php echo PROJECT_URL . '/?page=client_revised_tax_invoice_list'; ?>"><i class="fa fa-circle" aria-hidden="true"></i>All Revised Tax Invoice</a></li><?php } ?>
                                ...
                                <?php if ($db_obj->can_read('client_invoice')) { ?><li><a href="<?php echo PROJECT_URL . '/?page=client_special_tax_invoice_list'; ?>"><i class="fa fa-circle" aria-hidden="true"></i>All Special Cases Tax Invoice</a></li><?php } ?>
...
<!--                <li><a href="#"><i class="fa fa-hourglass-half" aria-hidden="true"></i> <span class="collapse in hidden-xs">Time of Supply</span></a></li>
            ...
            <?php if ($db_obj->can_read('admin_list')) { ?>
                    ...
                    <span class="collapse in hidden-xs">Client Settings<span class="navrgtarrow"><i class="fa fa-chevron-right" aria-hidden="true"></i></span></span></a>
                             <ul class="nav nav-stacked collapse left-submenu" id="item8">
                                <li><a href="<?php echo PROJECT_URL; ?>/?page=client_kycupdate"><i class="fa fa-circle" aria-hidden="true"></i>Update KYC</a></li>
                                <li><a href="<?php echo PROJECT_URL; ?>/?page=user_themesetting"><i class="fa fa-circle" aria-hidden="true"></i>Setting</a></li>
                            </ul>
                        </li>
                ...
                <li><a href="<?php echo PROJECT_URL . '/?page=client_return'; ?>"><i class="fa fa-refresh"></i> <span class="collapse in hidden-xs">Return</span></a></li>
                <?php } ?>
        ...
        <div class="column col-md-10 col-sm-9 col-xs-6" id="main" style="padding-right:0px; padding-top:0px; padding-left:0px;">
           ...
           <div class="headertop shadow">
                <div class="topnav">
                    ...
                    <li><div class="tollfreenumber" style="margin-top:-15px;">Toll Free<br/> <span>1800-212-2022</span> </div><span class="iconphone"></span>
                    </li>
