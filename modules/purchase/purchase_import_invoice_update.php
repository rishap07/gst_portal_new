			...
			<div class="whitebg formboxcontainer">
				...
				<div class="row">
					...
					<div class="col-md-12 col-sm-12 col-xs-12 form-group">
						...
						<div class="radio">
							<label><input type="radio" name="import_supply_meant" value="withpayment" <?php if($invoiceData[0]->import_supply_meant === "withpayment") { echo 'checked="checked"'; } ?>>SUPPLY MEANT FOR IMPORT ON PAYMENT OF INTEGRATED TAX</label>
						</div>
						<div class="radio">
				 ...
				 <div class="row">
					...
					<div class="col-md-6">
						<div class="greyborder inovicedeatil">
							...
							<div class="row form-group">
								<div class="col-md-4 col-sm-3 col-xs-12 padleftnone"><label>State Name</label> <span class="starred">*</span></div>
								<div class="col-md-8 col-sm-3 col-xs-12"><input type="text" placeholder="State Name" data-bind="content" class="form-control required" value="<?php echo $invoiceData[0]->supplier_billing_state_name; ?>" name="supplier_billing_state_name" id="supplier_billing_state_name" /></div>
							</div>
							...
							<div class="row form-group">
								...
								<div class="col-md-8 col-sm-3 col-xs-12">
									<select name='supplier_billing_country' id='supplier_billing_country' class='required form-control'>
										<?php $dataBCountryArrs = $obj_purchase->get_results("select * from ".$obj_purchase->getTableName('country')." order by country_name asc"); ?>
					...
					<div class="col-md-6">
						<div class="greyborder inovicedeatil">
							...
							<div class="row form-group">
								...
								<div class="col-md-8 col-sm-3 col-xs-12"><input type="text" placeholder="Import Bill Number" name='import_bill_number' class="form-control required" id='import_bill_number' data-bind="content" value="<?php echo $invoiceData[0]->import_bill_number; ?>" /></div>
							</div>

							<div class="row form-group">
								<div class="col-md-4 col-sm-3 col-xs-12 padleftnone"><label>Import Bill Date</label> <span class="starred">*</span></div>
								<div class="col-md-8 col-sm-3 col-xs-12"><input type="text" placeholder="Import Bill Date" class="form-control required" name='import_bill_date' id='import_bill_date' data-bind="date" value="<?php echo $invoiceData[0]->import_bill_date; ?>" /></div>
							</div>
