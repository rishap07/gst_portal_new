<?php
	...
	if( isset($_GET['action']) && $_GET['action'] == 'editPurchaseBOSInvoice' && isset($_GET['id']) && $obj_purchase->validateId($_GET['id'])) {
...
<form name="create-invoice" id="create-invoice" method="POST">
	<div class="col-md-12 col-sm-12 col-xs-12 padrgtnone mobpadlr formcontainer">
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div class="col-md-12 col-sm-12 col-xs-12 heading"><h1>Update Bill of Supply</h1></div>
    ...
    $(document).ready(function () {
		...
		$("#save_add_new_invoice").click(function(){
			...
			if(flag === 1) {
				...
				$("#loading").show();
				$.ajax({
					data: {invoiceData:$("#create-invoice").serialize(), action:"saveUpdatePurchaseBillInvoice"},
					dataType: 'json',
					type: 'post',
					url: "<?php echo PROJECT_URL; ?>/?ajax=purchase_bill_of_supply_invoice_save_update",
					success: function(response){
