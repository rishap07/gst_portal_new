			...
			<div class="whitebg formboxcontainer">
				...
				<div class="row">
					<div class="col-md-5 col-sm-5 col-xs-12 form-group">
						...
						<label class="radio-inline"><input type="radio" name="invoice_type" value="deemedimportinvoice" checked="checked">Deemed Import</label>
						<label class="radio-inline"><input type="radio" name="invoice_type" value="importinvoice">Import</label>
					...
					<div class="col-md-7 col-sm-7 col-xs-12 form-group">
						...
						<div class="radio">
							<label><input type="radio" name="import_supply_meant" value="withpayment" checked="checked">SUPPLY MEANT FOR EXPORT ON PAYMENT OF INTEGRATED TAX</label>
						</div>
						<div class="radio">
					...
					<div class="col-md-6">
						<div class="greyborder inovicedeatil">
							...
							<div class="row form-group importinformation">
								...
								<div class="col-md-8 col-sm-3 col-xs-12"><input type="text" placeholder="Import Bill Number" name='import_bill_number' class="form-control" id='import_bill_number' data-bind="content" /></div>
							</div>

							<div class="row form-group importinformation">
								<div class="col-md-4 col-sm-3 col-xs-12 padleftnone"><label>Import Bill Port Code</label></div>
								<div class="col-md-8 col-sm-3 col-xs-12">
									<input type="text" placeholder="Import Bill Port Code" name='import_bill_port_code' class="form-control" id='import_bill_port_code' data-bind="content" />
									<small class="text-muted"><b>Mandatory in the case supply of goods.</b></small>
								</div>
							</div>
				 ...
				 <div class="table-responsive">
					<table width="100%" border="0" cellspacing="0" cellpadding="4" class="table invoicetable tablecontent">
						<tr>
							...
							<th rowspan="2" class="advancecol active">Advance (<i class="fa fa-inr"></i>)</th>
						...
						<tr class="invoice_tr" data-row-id="1" id="invoice_tr_1">
							...
							<td class="advancecol">
								<div style="width:100px;" class="padrgt0">
									<input type="text" style="width:100%;" id="invoice_tr_1_advancevalue" name="invoice_advancevalue[]" class="validateDecimalValue invoiceAdvanceValue inptxt" value="0.00" data-bind="decimal" placeholder="0.00">
								</div>
							</td>
							<td>
								<div style="width:100px;" class="padrgt0">
						...
						<tr class="consolidateTotal">
							...
							<td class="lightblue fontbold textsmall advancecol consolidateAdvanceTotal" align="center"><span>0.00</span></td>
