<?php
    ...
    $purchaseInvoiceNumber = $obj_purchase->generatePurchaseInvoiceNumber( $obj_purchase->sanitize($_SESSION['user_detail']['user_id']) );
...
<form name="create-invoice" id="create-invoice" method="POST">
	<div class="col-md-12 col-sm-12 col-xs-12 padrgtnone mobpadlr formcontainer">
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div class="col-md-12 col-sm-12 col-xs-12 heading"><h1>Generate Purchase Import Tax Invoice</h1></div>
			...
			<div class="whitebg formboxcontainer">
				...
				<div class="row">
					...
					<div class="col-md-12 col-sm-12 col-xs-12 form-group">
						...
						<div class="radio">
							<label><input type="radio" name="import_supply_meant" value="withpayment" checked="checked">SUPPLY MEANT FOR IMPORT ON PAYMENT OF INTEGRATED TAX</label>
						</div>
						<div class="radio">
							<label><input type="radio" name="import_supply_meant" value="withoutpayment">SUPPLY MEANT FOR IMPORT UNDER BOND OR LETTER OF UNDERTAKING WITHOUT PAYMENT OF INTEGRATED TAX</label>
						</div>
					</div>
				</div>
				 ...
				 <div class="row">
					...
					<div class="col-md-4 col-sm-4 col-xs-12 form-group">
						...
						<input type="text" placeholder="Invoice Serial Number" readonly="true" class="form-control required" value="<?php echo $purchaseInvoiceNumber; ?>" name="invoice_serial_number" id="invoice_serial_number" />
					</div>
					...
					<div class="col-md-4 col-sm-4 col-xs-12 form-group">
						...
						<input type="text" placeholder="Invoice Reference Number" class="required form-control" data-bind="content" value="<?php echo $purchaseInvoiceNumber; ?>" name="invoice_reference_number" id="invoice_reference_number" />
					</div>
				 </div>
					...
					<div class="col-md-6">
						<div class="greyborder inovicedeatil">
							...
							<div class="row form-group">
								...
								<div class="col-md-8 col-sm-3 col-xs-12"><input type="text" placeholder="State Name" data-bind="content" class="form-control required" name="supplier_billing_state_name" id="supplier_billing_state_name" /></div>
							</div>
					...
					<div class="col-md-6">
						<div class="greyborder inovicedeatil">
							...
							<div class="row form-group">
								...
								<div class="col-md-8 col-sm-3 col-xs-12"><input type="text" placeholder="State Code" name='recipient_shipping_state_code' readonly="true" class="form-control required" id='recipient_shipping_state_code' /></div>
							</div>
							...
							<div class="row form-group">
								...
								<div class="col-md-8 col-sm-3 col-xs-12"><input type="text" placeholder="Import Bill Number" name='import_bill_number' class="form-control required" id='import_bill_number' data-bind="content" /></div>
							</div>

							<div class="row form-group">
								<div class="col-md-4 col-sm-3 col-xs-12 padleftnone"><label>Import Bill Date</label> <span class="starred">*</span></div>
								<div class="col-md-8 col-sm-3 col-xs-12"><input type="text" placeholder="Import Bill Date" class="form-control required" name='import_bill_date' id='import_bill_date' data-bind="date" /></div>
							</div>
						...
						<tr class="invoice_tr" data-row-id="1" id="invoice_tr_1">
							...
							<td class="advancecol">
								<div style="width:100px;" class="padrgt0">
									<i class="fa fa-inr"></i><input type="text" style="width:90%;" id="invoice_tr_1_advancevalue" name="invoice_advancevalue[]" class="validateInvoiceAmount invoiceAdvanceValue inptxt" value="0.00" data-bind="decimal" placeholder="0.00">
								</div>
							</td>
							<td>
								<div style="width:100px;" class="padrgt0">
							...
							<td>
								<input type="text" id="invoice_tr_1_igstrate" name="invoice_igstrate[]" class="inptxt validateInvoiceAmount invigstrate" placeholder="0.00" style="width:75px;" />
							</td>
							<td>
								<div style="width:100px;" class="padrgt0">
							...
							<td>
								<input type="text" id="invoice_tr_1_cessrate" name="invoice_cessrate[]" class="inptxt validateInvoiceAmount invcessrate" placeholder="0.00" style="width:75px;" />
							</td>
							<td>
								<div style="width:100px;" class="padrgt0">
    ...
    $(document).ready(function () {
		...
		$("#save_add_new_invoice").click(function(){
			...
			if(flag === 1) {
				...
				$.ajax({
					data: {invoiceData:$("#create-invoice").serialize(), action:"saveNewPurchaseTaxImportInvoice"},
					dataType: 'json',
					type: 'post',
					url: "<?php echo PROJECT_URL; ?>/?ajax=purchase_import_invoice_save",
					success: function(response){
