            ...
            <div class="row">
                ...
                <div class="fixed-left-col col-sm-12 col-xs-12" style="padding-right:0px; padding-left:0px;">
                    <div class="invoiceheaderfixed">
						...
						<?php $invoiceMonthYear = $obj_purchase->getInvoiceMonthList($obj_purchase->getTableName('client_purchase_invoice'), "'paymentvoucherinvoice'"); ?>
        ...
        return {
            init: function () {
                ...
                $('#mainTable').dataTable({
                    ...
                    "searching": false,
                    "bLengthChange": false,
                    "sAjaxSource": "<?php echo PROJECT_URL; ?>/?ajax=purchase_payment_voucher_invoice_list&invoiceDate=" + $("#invoiceDateOption option:selected").val(),
