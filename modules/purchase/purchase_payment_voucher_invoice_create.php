<?php
	...
	$rvPurchaseInvoiceNumber = $obj_purchase->generatePurchasePVInvoiceNumber( $obj_purchase->sanitize($_SESSION['user_detail']['user_id']) );
?>
...
<form name="create-invoice" id="create-invoice" method="POST">
	...
	<div class="col-md-12 col-sm-12 col-xs-12 padrgtnone mobpadlr formcontainer">
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div class="col-md-12 col-sm-12 col-xs-12 heading"><h1>Payment Voucher Invoice</h1></div>
				...
				<div class="errorValidationContainer">
				 ...
				 <div class="row">
					<div class="col-md-4 col-sm-4 col-xs-12 form-group">
						<label>Payment Voucher <span class="starred">*</span></label>
						...
						<tr class="invoice_tr" data-row-id="1" id="invoice_tr_1">
							...
							<td>
								<div style="width:100px;" class="padrgt0">
									</i><input type="text" style="width:100%;" id="invoice_tr_1_taxablevalue" name="invoice_taxablevalue[]" class="required validateDecimalValue invoiceTaxableValue inptxt" data-bind="decimal" placeholder="0.00" />
								</div>
							</td>
							<td>
    ...
    $(document).ready(function () {
        ...
        $(".invoicetable .addMoreInvoice").click(function() {
            ...
            var newtr = '<tr class="invoice_tr" data-row-id="'+nexttrid+'" id="invoice_tr_'+nexttrid+'">';
				...
				newtr += '<td><div style="width:100px;" class="padrgt0"><input type="text" style="width:100%;" id="invoice_tr_'+nexttrid+'_taxablevalue" name="invoice_taxablevalue[]" class="required validateDecimalValue invoiceTaxableValue inptxt" data-bind="decimal" placeholder="0.00" /></div></td>';
	   ...
	   /* validate invoice form */
		...
		$("#save_add_new_invoice").click(function(){
			...
			if(flag === 1) {
				...
				$("#loading").show();
				$.ajax({
					data: {invoiceData:$("#create-invoice").serialize(), action:"saveNewPurchasePVInvoice"},
					dataType: 'json',
					type: 'post',
					url: "<?php echo PROJECT_URL; ?>/?ajax=purchase_payment_voucher_invoice_save",
					success: function(response){
