            ...
            <div class="row">
                ...
                <div class="fixed-left-col col-sm-12 col-xs-12" style="padding-right:0px; padding-left:0px;">
                    ...
                    <div class="invoiceheaderfixed">
						...
						<?php $invoiceMonthYear = $obj_purchase->getInvoiceMonthList($obj_purchase->getTableName('client_purchase_invoice'), "'refundvoucherinvoice'"); ?>
											...
											<table>
												<tr>
													...
													<td style="text-align:right;vertical-align:top;">
                                                        ...
                                                        <b><?php if(isset($dataInvoiceSettingArr['data']->type_label) && !empty($dataInvoiceSettingArr['data']->type_label)) { echo $dataInvoiceSettingArr['data']->type_label; } else { echo "Type"; } ?></b>: <?php echo "Refund Invoice"; ?><br>
        ...
        return {
            init: function () {
                ...
                $('#mainTable').dataTable({
                    ...
                    "searching": false,
                    "bLengthChange": false,
                    "sAjaxSource": "<?php echo PROJECT_URL; ?>/?ajax=purchase_refund_voucher_invoice_list&invoiceDate=" + $("#invoiceDateOption option:selected").val(),
