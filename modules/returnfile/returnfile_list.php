...
<div class="col-md-12 col-sm-12 col-xs-12 padrgtnone mobpadlr formcontainer">
    <div class="col-md-12 col-sm-12 col-xs-12">
       ...
       <h1>ReturnFile List</h1>
        ...
        <div>
            <a class='btn btn-default btn-success btnwidth addnew' href='<?php echo PROJECT_URL;?>/?page=returnfile_update'>Add New</a>
        </div>
        ...
        return {
            init: function () {
                ...
                $('#mainTable').dataTable({
                    ...
                    "bStateSave": false,
                    "bDestroy": true,
                    "sAjaxSource": "<?php echo PROJECT_URL; ?>/?ajax=returnfile_list",
