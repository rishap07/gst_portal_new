	...
	if (isset($_POST['returnmonth'])) 
{
   ...
   $obj_gstr1->redirect(PROJECT_URL . "/?page=return_gstr1a_view_invoices&returnmonth=" . $returnmonth);
   exit();
}
}
    ...
    <div class="col-md-11 col-sm-12 col-xs-12 mobpadlr">
        <div class="col-md-12 col-sm-12 col-xs-12 heading">
            <div class="tab col-md-12 col-sm-12 col-xs-12">
                <a href="<?php echo PROJECT_URL . '/?page=return_gstr1a_summary&returnmonth=' . $returnmonth ?>" >
                    View GSTR1 Summary
                </a>
                <a href="<?php echo PROJECT_URL . '/?page=return_gstr1a_view_invoices&returnmonth=' . $returnmonth ?>" class="active">
                    View My Invoice
                </a>
...
<script>
    $(document).ready(function () {
        $('#returnmonth,.type').on('change', function () {
            ...
            document.form2.action = '<?php echo PROJECT_URL; ?>/?page=return_gstr1a_view_invoices&returnmonth=<?php echo $returnmonth; ?>';
