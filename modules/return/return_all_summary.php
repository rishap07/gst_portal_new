...
<div class="tab">
<a href="<?php echo PROJECT_URL.'/?page=return_summary'?>">
  <button class="tablinks" onclick="openCity(event, 'London')">View GSTR1 Summary</button></a>
  <a href="<?php echo PROJECT_URL.'/?page=return_view_invoices'?>">
  <button class="tablinks" onclick="openCity(event, 'Paris')">View My Invoice</button></a>
  <a href="<?php echo PROJECT_URL.'/?page=return_upload_invoices'?>">
  <button class="tablinks" onclick="openCity(event, 'Tokyo')">Upload To GSTN</button></a>
</div>
