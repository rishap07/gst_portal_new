...
<script type="text/javascript">
    $(document).ready(function () {
	  ...
	  var markup1='<tr><table id="expanddemo" class="expanddemo" class="table  tablecontent tablecontent2 bordernone"><thead><tr><th>Rate(%)</th><th>Gross Advance Amount (Excluding Tax)(<i class="fa fa-inr"></i>) </th><th>IGST Amount(<i class="fa fa-inr"></i>) </th><th>CGST Amount(<i class="fa fa-inr"></i>) </th><th>SGST Amount(<i class="fa fa-inr"></i>) </th><th>CESS Amount(<i class="fa fa-inr"></i>) </th></tr></thead><tbody>';
