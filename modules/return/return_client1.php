<?php
 ...
 //$to_time=time();
//$from_time=strtotime($dataRes[0]->otp_date); 
//echo round(abs(time() - $from_time) / 60,2)." minute"; die;
...
<div class="col-md-12 col-sm-12 col-xs-12 padrgtnone mobpadlr">
	...
	// INNER join  " . $db_obj->getTableName("return_subcat") . " as subcat on subcat.id = s.subcat_id where c.id = 1 order by order_value asc";
