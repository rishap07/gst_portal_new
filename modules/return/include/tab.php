 <ul>
                    ...
                    <li><a href="<?php echo PROJECT_URL . '/?page=return_reconcile&returnmonth=' . $returnmonth ?>" <?php if(isset($_REQUEST['page']) && $_REQUEST['page']=='return_reconcile') { echo 'class="active"';} ?>>GSTR-2 Reconcile</a></li>
