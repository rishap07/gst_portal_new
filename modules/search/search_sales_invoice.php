...
//export data start
 ...
 $(document).ready(function () {
	...
	var TableManaged = function () {
        return {
            init: function (salesSearchData,is_canceled,from_date,to_date) {
                if (!jQuery().dataTable) {
                    return;
                }
					
                var sgHREF = window.location.pathname;
                $.ajaxSetup({'type': 'POST', 'data' : {'salesSearchData':salesSearchData,'is_canceled':is_canceled,'from_date':from_date,'to_date':to_date}, 'url': sgHREF, 'dataType': 'json'});
