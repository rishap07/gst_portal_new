...
if(isset($rResult) && !empty($rResult)) {
    ...
    foreach($rResult as $aRow) {
		...
		if($aRow->invoice_type == "taxinvoice") {
			$row[] = '<a target="_blank" href="'.PROJECT_URL.'/?page=client_update_invoice&action=editInvoice&id='.$aRow->invoice_id.'" class="btn btn-success">Edit</a>';
		} else if($aRow->invoice_type == "exportinvoice") {
			$row[] = '<a target="_blank" href="'.PROJECT_URL.'/?page=client_update_export_invoice&action=editInvoice&id='.$aRow->invoice_id.'" class="btn btn-success">Edit</a>';
			...
			$row[] = '<a target="_blank" href="'.PROJECT_URL.'/?page=client_update_bill_of_supply_invoice&action=editBOSInvoice&id='.$aRow->invoice_id.'" class="btn btn-success">Edit</a>';
		} else if($aRow->invoice_type == "receiptvoucherinvoice") {
			$row[] = '<a target="_blank" href="'.PROJECT_URL.'/?page=client_update_receipt_voucher_invoice&action=editRVInvoice&id='.$aRow->invoice_id.'" class="btn btn-success">Edit</a>';
		} else if($aRow->invoice_type == "refundvoucherinvoice") {
			$row[] = '<a target="_blank" href="'.PROJECT_URL.'/?page=client_update_refund_voucher_invoice&action=editRFInvoice&id='.$aRow->invoice_id.'" class="btn btn-success">Edit</a>';
		} else if($aRow->invoice_type == "revisedtaxinvoice") {
			$row[] = '<a target="_blank" href="'.PROJECT_URL.'/?page=client_update_revised_tax_invoice&action=editRTInvoice&id='.$aRow->invoice_id.'" class="btn btn-success">Edit</a>';
		} else if($aRow->invoice_type == "creditnote") {
			$row[] = '<a target="_blank" href="'.PROJECT_URL.'/?page=client_update_revised_tax_invoice&action=editRTInvoice&id='.$aRow->invoice_id.'" class="btn btn-success">Edit</a>';
		} else if($aRow->invoice_type == "debitnote") {
			$row[] = '<a target="_blank" href="'.PROJECT_URL.'/?page=client_update_revised_tax_invoice&action=editRTInvoice&id='.$aRow->invoice_id.'" class="btn btn-success">Edit</a>';
		} else if($aRow->invoice_type == "deliverychallaninvoice") {
			$row[] = '<a target="_blank" href="'.PROJECT_URL.'/?page=client_update_delivery_challan_invoice&action=editDCInvoice&id='.$aRow->invoice_id.'" class="btn btn-success">Edit</a>';
		}
