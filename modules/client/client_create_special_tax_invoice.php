<?php
    ...
    $stInvoiceNumber = $obj_client->generateSTInvoiceNumber( $obj_client->sanitize($_SESSION['user_detail']['user_id']) );
?>
<!--POPUP START HERE-->
                ...
                <div class="kycform">
                    <div class="kycmainbox invoiceform">
						...
						<div class="formcol">
                            ...
                            <input type="text" placeholder="Invoice Serial Number" readonly="true" class="readonly required" data-bind="content" value="<?php echo $stInvoiceNumber; ?>" name="invoice_serial_number" id="invoice_serial_number" />
                        </div>
						...
						<div class="formcol">
                            <label>Input Service Distributor Name <span class="starred">*</span></label>
						...
						<div class="formcol two">
                            <label>Input Service Distributor Address <span class="starred">*</span></label>
						...
						<div class="formcol third">
                            <label>Input Service Distributor State <span class="starred">*</span></label>
                        ...
                        <div class="formcol">
                            <label>Input Service Distributor GSTIN <span class="starred">*</span></label>
                        ...
                        <div class="col-md-6" style="padding-left:0px;">
                            <div class="inovicedeatil">
                                ...
                                <div class="formcol">
                                    ...
                                    <textarea placeholder="Address" class="required" data-bind="address" name="billing_address" id="billing_address"></textarea>
                                </div>
                                ...
                                <div class="formcol">
                                    ...
                                    <input type="text" placeholder="GSTIN/UIN" data-bind="alphanum" name='billing_gstin_number' id='billing_gstin_number' />
                                </div>
                        ...
                        <div class="col-md-6 greyborder">
                            <div class="inovicedeatil">
                                ...
                                <div class="formcol">
                                    <label>Address <span class="starred">*</span></label>
                                    <textarea placeholder="Address" class="required" data-bind="address" name="shipping_address" id="shipping_address"></textarea>
                                </div>
                                ...
                                <div class="formcol">
                                    <label>GSTIN</label>
                                    <input type="text" placeholder="GSTIN" data-bind="alphanum" name='shipping_gstin_number' id='shipping_gstin_number' />
                                </div>
                        ...
                        <div class="tableresponsive">
							<table width="100%" border="0" cellspacing="0" cellpadding="4" class="tablecontent invoicetable">
								<tr>
									...
									<th rowspan="2">Description<br/> of Services</th>
									<th rowspan="2">SAC Code<br/>(GST)</th>
									<th rowspan="2">Qty</th>
    ...
    $(document).ready(function () {
        ...
        $(".invoicetable").on("keypress", ".autocompleteitemname", function(){
            ...
            $( "#invoice_tr_"+rowid+"_itemname" ).autocomplete({
                minLength: 1,
                source: "<?php echo PROJECT_URL; ?>/?ajax=client_get_item&itype=service",
                select: function( event, ui ) {
		...
		$("#save_add_new_invoice").click(function(){
			...
			if(flag === 1) {
				...
				$.ajax({
					data: {invoiceData:$("#create-invoice").serialize(), action:"saveNewSTInvoice"},
					dataType: 'json',
					type: 'post',
					url: "<?php echo PROJECT_URL; ?>/?ajax=client_save_special_tax_invoice",
					success: function(response){
						...
						if(response.status == "error") {
							...
							window.location.href = '<?php echo PROJECT_URL; ?>/?page=client_create_special_tax_invoice';
						}
					}
				});
			}
			...
			$.ajax({
                ...
                success: function(response){
                    ...
                    if(response.status == "error") {
                        ...
                        $(".errorValidationContainer").html("");
                        $(".errorValidationContainer").hide();
                        window.location.href = '<?php echo PROJECT_URL; ?>/?page=client_special_tax_invoice_list';
                    }
                }
            });
        });
