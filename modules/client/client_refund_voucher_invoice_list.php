                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if(!empty($dataReceiptVoucherRow)) { ?>
                                                            <b>Receipt Voucher Serial Number:</b> <?php echo $dataReceiptVoucherRow->serial_number; ?><br>
                                                            <b>Receipt Voucher Reference Number:</b> <?php echo $dataReceiptVoucherRow->reference_number; ?><br>
