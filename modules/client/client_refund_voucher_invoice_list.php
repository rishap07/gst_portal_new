...
if( isset($_GET['action']) && $_GET['action'] == 'deleteRFInvoice' && isset($_GET['id']) && $obj_client->validateId($_GET['id'])) {
...
<div class="col-md-12 col-sm-12 col-xs-12 padrgtnone mobpadlr formcontainer">
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div>
            <a class='btn btn-default btn-success btnwidth addnew' href='<?php echo PROJECT_URL;?>/?page=client_create_refund_voucher_invoice'>Add Refund Voucher Invoice</a>
        </div>
        <h1>Refund Voucher Invoice</h1>
        <hr class="headingborder">
        <h2 class="greyheading">Refund Voucher Invoice Listing</h2>
