...
if (isset($_GET['action']) && $_GET['action'] == 'downloadRFInvoice' && isset($_GET['id']) && $obj_client->validateId($_GET['id'])) {

    $htmlResponse = $obj_client->generateRFInvoiceHtml($_GET['id']);
...
if (isset($_GET['action']) && $_GET['action'] == 'emailRFInvoice' && isset($_GET['id']) && $obj_client->validateId($_GET['id'])) {
...
if (isset($_GET['action']) && $_GET['action'] == 'printRFInvoice' && isset($_GET['id']) && $obj_client->validateId($_GET['id'])) {
            ...
            <div class="row">
                ...
                <div class="fixed-left-col col-sm-12 col-xs-12" style="padding-right:0px; padding-left:0px;">
                    ...
                    <div class="invoiceheaderfixed">
						...
						<?php $invoiceMonthYear = $obj_client->getInvoiceMonthList($obj_client->getTableName('client_invoice'), "'refundvoucherinvoice'"); ?>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="padding-right:10px;padding-left:5px;">
                            <a href='<?php echo PROJECT_URL; ?>/?page=client_create_refund_voucher_invoice' class="btn btn-success pull-right"><i class="fa fa-plus" aria-hidden="true"></i> New</a>
                        </div>
                    </div>
                ...
                if (isset($_GET['action']) && $_GET['action'] == 'viewRFInvoice' && isset($_GET['id']) && $obj_client->validateId($_GET['id'])) {
					...
					$invoiceData = $obj_client->get_results("select 
												...
												cii.total 
												from 
											" . $obj_client->getTableName('client_invoice') . " as ci INNER JOIN " . $obj_client->getTableName('client_invoice_item') . " as cii ON ci.invoice_id = cii.invoice_id where ci.invoice_id = (SELECT invoice_id FROM ".$obj_client->getTableName('client_invoice')." Where invoice_type = 'refundvoucherinvoice' AND added_by = '" . $obj_client->sanitize($_SESSION['user_detail']['user_id']) . "' AND is_deleted='0' Order by invoice_id desc limit 0,1) AND ci.invoice_type = 'refundvoucherinvoice' AND ci.added_by = '" . $obj_client->sanitize($_SESSION['user_detail']['user_id']) . "' AND cii.added_by = '" . $obj_client->sanitize($_SESSION['user_detail']['user_id']) . "' AND ci.is_deleted='0' AND cii.is_deleted='0'");
				}
                    ...
                    <div class="col-md-8 col-sm-12 mobdisplaynone invoicergtcol">
                        ...
                        <div class="inovicergttop">
                            <ul class="iconlist">
                                ...
                                <li><a href="<?php echo PROJECT_URL; ?>/?page=client_update_refund_voucher_invoice&action=editRFInvoice&id=<?php echo $invoiceData[0]->invoice_id; ?>"><div data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></div></a></li>
                                <li><a href="<?php echo PROJECT_URL; ?>/?page=client_refund_voucher_invoice_list&action=downloadRFInvoice&id=<?php echo $invoiceData[0]->invoice_id; ?>"><div data-toggle="tooltip" data-placement="bottom" title="PDF"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></div></a></li>
                                <li><a href="<?php echo PROJECT_URL; ?>/?page=client_refund_voucher_invoice_list&action=printRFInvoice&id=<?php echo $invoiceData[0]->invoice_id; ?>" target="_blank"><div data-toggle="tooltip" data-placement="bottom" title="PRINT"><i class="fa fa-print" aria-hidden="true"></i></div></a></li>
                                <li><a href="<?php echo PROJECT_URL; ?>/?page=client_refund_voucher_invoice_list&action=emailRFInvoice&id=<?php echo $invoiceData[0]->invoice_id; ?>"><div data-toggle="tooltip" data-placement="bottom" title="Email"><i class="fa fa-envelope-o" aria-hidden="true"></i></div></a></li>
							</ul>
                        </div>
                                            ...
                                            <table>
                                                <tr>
													...
													<td style="text-align:right;vertical-align:top;">
                                                        ...
                                                        <b><?php if(isset($dataInvoiceSettingArr['data']->type_label) && !empty($dataInvoiceSettingArr['data']->type_label)) { echo $dataInvoiceSettingArr['data']->type_label; } else { echo "Type"; } ?></b>: <?php echo "Refund Voucher"; ?><br>
        ...
        return {
            init: function () {
                ...
                $('#mainTable').dataTable({
                    ...
                    "searching": false,
                    "bLengthChange": false,
                    "sAjaxSource": "<?php echo PROJECT_URL; ?>/?ajax=client_refund_voucher_invoice_list&invoiceDate=" + $("#invoiceDateOption option:selected").val(),
