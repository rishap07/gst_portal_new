...
<div class="col-md-12 col-sm-12 col-xs-12 padrgtnone mobpadlr formcontainer">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="col-md-12 col-sm-12 col-xs-12 heading"> <h1>Company Profile</h1></div>
                ...
                <div class="row">
                    ...
                    <?php if ($dataArr['data']->kyc != '' && isset($dataArr['data']->kyc->email)) { ?>
                        <div class="col-md-4 col-sm-4 col-xs-12 form-group">
                            ...
                            <input type="text" placeholder="Enter Email Address" name="email" id="email" class="required form-control" data-bind="email" value="<?php if (isset($_POST['email'])) {
        echo $_POST['email'];
    } else if (isset($dataArr['data']->kyc->email)) {
        echo $dataArr['data']->kyc->email;
    } ?>" />
                        </div>
                        <?php } else { ?>
                        <div class="col-md-4 col-sm-4 col-xs-12 form-group">
...
<?php } ?>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 form-group">
                            ...
                            <input type="text" placeholder="Enter Contact Number" name="phone_number" id="phone_number" class="required form-control" data-bind="mobilenumber" value="<?php
                        if (isset($_POST['phone_number'])) {
                            echo $_POST['phone_number'];
                        } else if (isset($dataArr['data']->kyc->phone_number)) {
                            echo $dataArr['data']->kyc->phone_number;
                        }
                        ?>" />
                        </div>
                        <?php } else { ?>
                        ...
                        if (isset($_POST['phone_number'])) {
                            echo $_POST['phone_number'];
                        } else if (isset($dataArr['data']->phone_number)) {
                            echo $dataArr['data']->phone_number;
                        }
                            ?>" />
                        </div>
                    <?php } ?>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 form-group">
                        ...
                        <input type="text" placeholder="yyyy-mm-dd" name="date_of_birth" id="date_of_birth" class="required form-control" data-bind="date" value="<?php
                        if (isset($_POST['date_of_birth'])) {
                            echo $_POST['date_of_birth'];
                        } else if (isset($dataArr['data']->kyc->date_of_birth)) {
                            echo $dataArr['data']->kyc->date_of_birth;
                        }
                        ?>" />
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-12 form-group">
                        <label>GSTIN Number<span class="starred">*</span></label>
                        <input type="text" name="gstin_number" id="gstin_number" placeholder="Enter gstin number" class="required form-control" data-bind="gstin" value="<?php
                        if (isset($_POST['gstin_number'])) {
                            echo $_POST['gstin_number'];
                        } else if (isset($dataArr['data']->kyc->gstin_number)) {
                            echo $dataArr['data']->kyc->gstin_number;
                        }
                        ?>" />
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-12 form-group">
                        <label>Pan Card No<span class="starred">*</span></label>
                        <input type="text" name="pan_card_number" id="pan_card_number" placeholder="Enter pan card number" class="required form-control" data-bind="pancard" value="<?php
                        if (isset($_POST['pan_card_number'])) {
                            echo $_POST['pan_card_number'];
                        } else if (isset($dataArr['data']->kyc->pan_card_number)) {
                            echo $dataArr['data']->kyc->pan_card_number;
                        }
                        ?>" />
                    </div>
                    <div class="clear"></div>
                    <div class="col-md-4 col-sm-4 col-xs-12 form-group">
                        ...
                        <input type="text" name="uid_number" class="form-control" id="uid_number" placeholder="Enter uid number" data-bind="alphanum" value="<?php
                        if (isset($_POST['uid_number'])) {
                            echo $_POST['uid_number'];
                        } else if (isset($dataArr['data']->kyc->uid_number)) {
                            echo $dataArr['data']->kyc->uid_number;
                        }
                        ?>" />
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-12 form-group">
                        ...
                        <div class="clear"></div>
                        <input type="radio" name="identity_proof" <?php
                        if (isset($_POST['identity_proof']) && $_POST['identity_proof'] === 'UID') {
                            echo 'checked="checked"';
                        } else if (isset($dataArr['data']->kyc->identity_proof) && $dataArr['data']->kyc->identity_proof === 'UID') {
                            echo 'checked="checked"';
                        }
                        ?> value="UID" /><span>UID(Aadhar)</span>
                        <input type="radio" name="identity_proof" <?php
                        if (isset($_POST['identity_proof']) && $_POST['identity_proof'] === 'P') {
                            echo 'checked="checked"';
                        } else if (isset($dataArr['data']->kyc->identity_proof) && $dataArr['data']->kyc->identity_proof === 'P') {
                            echo 'checked="checked"';
                        }
                        ?> value="P" /><span>Passport</span>
                        <input type="radio" name="identity_proof" <?php
                        if (isset($_POST['identity_proof']) && $_POST['identity_proof'] === 'VI') {
                            echo 'checked="checked"';
                        } else if (isset($dataArr['data']->kyc->identity_proof) && $dataArr['data']->kyc->identity_proof === 'VI') {
                            echo 'checked="checked"';
                        }
                        ?> value="VI" /><span>Voter Id</span>
                        <input type="radio" name="identity_proof" <?php
                        if (isset($_POST['identity_proof']) && $_POST['identity_proof'] === 'DL') {
                            echo 'checked="checked"';
                        } else if (isset($dataArr['data']->kyc->identity_proof) && $dataArr['data']->kyc->identity_proof === 'DL') {
                            echo 'checked="checked"';
                        }
                        ?> value="DL" /><span>Driving License</span>
                        <input type="radio" name="identity_proof" <?php
                            if (isset($_POST['identity_proof']) && $_POST['identity_proof'] === 'O') {
                                echo 'checked="checked"';
                            } else if (isset($dataArr['data']->kyc->identity_proof) && $dataArr['data']->kyc->identity_proof === 'O') {
                                echo 'checked="checked"';
                            }
                        ?> value="O" /><span>Others</span>
                    </div>
                    <?php if ($dataArr['data']->kyc != '' && isset($dataArr['data']->kyc->proof_photograph)) { ?>
                        <div class="col-md-4 col-sm-4 col-xs-12 form-group">
                            ...
                            <span class="greysmalltxt">(supported file extension are .jpg,.jpeg,.png)</span>
                        </div>
                    <?php } else { ?>
                        <div class="col-md-4 col-sm-4 col-xs-12 form-group">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 form-group">
                        ...
                        <select name='business_type' id='business_type' class='required form-control'>
                            ...
                            <?php if (!empty($dataBusinessArrs)) { ?>
                                ...
                                <?php foreach ($dataBusinessArrs as $dataBusinessArr) { ?>
                                    <option value='<?php echo $dataBusinessArr->business_area_id; ?>' <?php
                                    if ($dataArr['data']->kyc->business_area == $dataBusinessArr->business_area_id) {
                                        echo "selected='selected'";
                                    }
                                    ?>><?php echo $dataBusinessArr->business_area_name; ?></option>
                                <?php } ?>
                            <?php } ?>
                        </select>
                    </div>
                        ...
                        <select name='vendor_type' id='vendor_type' class='required form-control'>
                            ...
                            <?php if (!empty($dataVendorArrs)) { ?>
                                ...
                                <?php foreach ($dataVendorArrs as $dataVendorArr) { ?>
                                    ...
                                    if ($dataArr['data']->kyc->vendor_type == $dataVendorArr->vendor_id) {
                                        echo "selected='selected'";
                                    }
