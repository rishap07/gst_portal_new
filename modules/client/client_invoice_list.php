            ...
            <div class="row">
                ...
                <div class="fixed-left-col col-sm-12 col-xs-12" style="padding-right:0px; padding-left:0px;">
                    ...
                    <div class="invoiceheaderfixed">
						...
						<?php $invoiceMonthYear = $obj_client->getInvoiceMonthList($obj_client->getTableName('client_invoice'), "'taxinvoice','exportinvoice','sezunitinvoice','deemedexportinvoice'"); ?>
        ...
        return {
            init: function () {
                ...
                $('#mainTable').dataTable({
                    ...
                    "searching": false,
                    "bLengthChange": false,
                    "sAjaxSource": "<?php echo PROJECT_URL; ?>/?ajax=client_invoice_list&invoiceDate=" + $("#invoiceDateOption option:selected").val(),
