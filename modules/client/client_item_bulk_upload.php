...
if(isset($_POST['submit']) && $_POST['submit']=='submit') {
	...
	if(!isset($_SERVER['HTTP_REFERER']) || empty($_SERVER['HTTP_REFERER'])){
        ...
        $uploadInvoice = $obj_client->uploadClientMasterItem();
...
<div class="col-md-12 col-sm-12 col-xs-12 padrgtnone mobpadlr formcontainer">
	<div class="col-md-12 col-sm-12 col-xs-12">
		...
		<div class="whitebg formboxcontainer">
			...
			<form name="upload-item" id="upload-item" method="POST" enctype="multipart/form-data">
				<div class="row">

					<div class="col-md-4 col-sm-4 col-xs-12 form-group">
						<label>Upload Excel File <span class="starred">*</span></label>
						<div class="clear"></div>
						<input type="file" name="item_xlsx" id="item_xlsx" class="required form-control" />
					</div>
...
<script>
    $(document).ready(function () {
        $('#submit').click(function () {
            var mesg = {};
            if (vali.validate(mesg,'upload-item')) {
				return true;
            }
            return false;
        });
