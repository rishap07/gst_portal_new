				 ...
				 <div class="row">
					...
					<div class="col-md-6">
						<div class="greyborder inovicedeatil">
							...
							<div class="row form-group">
								...
								<div class="col-md-8 col-sm-3 col-xs-12"><input type="text" placeholder="State Code" name='billing_state_code' readonly="true" class="form-control required" id='billing_state_code' value="<?php echo $billing_state_data['data']->state_code; ?>" /></div>
							</div>
					...
					<div class="col-md-6">
						<div class="greyborder inovicedeatil">
							...
							<div class="row form-group">
								<div class="col-md-4 col-sm-3 col-xs-12 padleftnone"><label>State Code</label> <span class="starred">*</span></div>
								<div class="col-md-8 col-sm-3 col-xs-12"><input type="text" placeholder="State Code" name='shipping_state_code' readonly="true" class="form-control required" id='shipping_state_code' value="<?php echo $shipping_state_data['data']->state_code; ?>" /></div>
							</div>
				 ...
				 <div class="table-responsive">
					<table width="100%" border="0" cellspacing="0" cellpadding="4" class="table invoicetable tablecontent">
						...
						<tr class="tdsamount" <?php if($invoiceData[0]->supply_type === "tds") { echo 'style="display:table-row;"'; } ?>>
							<td <?php if($invoiceData[0]->advance_adjustment == 1) { echo 'colspan="10"'; } else { echo 'colspan="9"'; } ?> align="right" class="lightgreen fontbold textsmall tdsamountftd">Amount of Tax Subject to TDS</td>
						...
						<tr class="tcsamount" <?php if($invoiceData[0]->supply_type === "tcs") { echo 'style="display:table-row;"'; } ?>>
							<td <?php if($invoiceData[0]->advance_adjustment == 1) { echo 'colspan="10"'; } else { echo 'colspan="9"'; } ?> align="right" class="lightgreen fontbold textsmall tcsamountftd">Amount of Tax Subject to TCS</td>
	...
	$(document).ready(function () {
        ...
        function rowInvoiceCalculation(itemid, rowid) {
			...
			if(
				...
				$("#invoice_tr_"+rowid+"_cgstrate").addClass("readonly");
				$("#invoice_tr_"+rowid+"_sgstrate").prop("readonly", true);
				$("#invoice_tr_"+rowid+"_sgstrate").addClass("readonly");
				$("#invoice_tr_"+rowid+"_igstrate").prop("readonly", false);
				$("#invoice_tr_"+rowid+"_igstrate").removeClass("readonly");
				...
				if(supplierStateId === receiverStateId) {
					...
					$("#invoice_tr_"+rowid+"_cgstrate").removeClass("readonly");
					$("#invoice_tr_"+rowid+"_sgstrate").prop("readonly", false);
					$("#invoice_tr_"+rowid+"_sgstrate").removeClass("readonly");
					$("#invoice_tr_"+rowid+"_igstrate").prop("readonly", true);
					$("#invoice_tr_"+rowid+"_igstrate").addClass("readonly");
					...
					$("#invoice_tr_"+rowid+"_cessrate").removeClass("readonly");
