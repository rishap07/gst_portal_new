                ...
                <div class="kycform">
                    <div class="kycmainbox invoiceform">
                        ...
                        <div class="formcol">
                            ...
                            <input type="text" placeholder="Cyfuture India Pvt. Ltd" data-bind="content" readonly="true" class="readonly required" name="company_name" id="company_name" value="<?php echo $dataCurrentUserArr['data']->company_name; ?>" />
                        </div>
                        
                        <div class="formcol">
                            <label>GSTIN Number <span class="starred">*</span></label>
                            <input type="text" placeholder="BYRAJ14N3KKT" name="company_gstin_number" data-bind="alphanum" readonly="true" class="readonly required" id="company_gstin_number" value="<?php if(isset($dataCurrentUserArr['data']->gstin->gstin_number)) { echo $dataCurrentUserArr['data']->gstin->gstin_number; } ?>" />
                        </div>
                        ...
                        <div class="formcol third">
                            ...
                            <input type="text" placeholder="Place Of Supply" data-bind="content" readonly="true" class="readonly required" name="place_of_supply" id="place_of_supply" value="<?php if(isset($dataCurrentUserArr['data']->kyc->state_name)) { echo $dataCurrentUserArr['data']->kyc->state_name; } ?>" />
                        ...
                        <div class="col-md-6 greyborder">
                            <div class="inovicedeatil">
                                <h4>Shipping Detail<small class="pull-right">Same AS Billing<input name="same_as_billing" id="same_as_billing" value="1" type="checkbox"></small></h4>
