...
<div class="admincontainer greybg">
    <div class="formcontainer" style="padding:20px;">
        ...
        <h1>Generate Transportation Of Goods Invoice</h1>
            ...
            <div class="adminformbx">
                <div class="kycform">
                    <div class="kycmainbox invoiceform">
						...
						<div class="formcol third">
                            <label>Date & No. of Delivery Challan<span class="starred">*</span></label>
                            <input type="text" placeholder="Date & No. of Delivery Challan" class="required" name="challan_date" id="challan_date" />
                        </div>
						...
						<div class="formcol third">
							...
							<select name='place_of_receiver' id='place_of_receiver' class='required'>
								<?php $dataRStateArrs = $obj_client->get_results("select * from ".$obj_client->getTableName('state')." where status='1' and is_deleted='0' order by state_name asc"); ?>
								<?php if(!empty($dataRStateArrs)) { ?>
									<option value=''>Select Place Of Supply</option>
									<?php foreach($dataRStateArrs as $dataRStateArr) { ?>
										<option value='<?php echo $dataRStateArr->state_id; ?>' data-code="<?php echo $dataRStateArr->state_code;?>"><?php echo $dataRStateArr->state_name; ?></option>
									<?php } ?>
								<?php } ?>
							</select>
						</div>
						...
						<div class="formcol">
                            <label>No. of Delivery Challan<span class="starred">*</span></label>
                            <input type="text" placeholder="No. of Delivery Challan" class="required" name="no_delivery_challan" id="no_delivery_challan" />
                        </div>
						
						<div class="formcol two">
                            <label>Date of Delivery Challan<span class="starred">*</span></label>
                            <input type="text" placeholder="Date of Delivery Challan" class="required" name="date_delivery_challan" id="date_delivery_challan" />
                        </div>
                        ...
                        <div class="col-md-6 greyborder">
                            <div class="inovicedeatil">
                                <h4>Shipping Detail/Address Of Delivery<small class="pull-right">Same AS Billing<input name="same_as_billing" id="same_as_billing" value="1" type="checkbox"></small></h4>
                                ...
                                <div class="formcol">
                                    <label>GSTIN Number</label>
                                    <input type="text" placeholder="GSTIN Number" name='shipping_gstin_number' data-bind="alphanum" id='shipping_gstin_number' />
                                </div>
                        ...
                        <div class="tableresponsive">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="4" class="tablecontent invoicetable">
                                ...
                                <tr>
                                    <td colspan="11" align="right" class="lightyellow totalamount">Total Invoice Value <span>(In Figure)</span><div class="totalprice"><i class="fa fa-inr"></i><span class="invoicetotalprice">0.00</span></div></td>
                                    <td class="lightyellow" align="left"></td>
                                </tr>

                                <tr>
                                    <td colspan="11" align="right" class="lightpink fontbold totalamountwords" style="font-size:13px;">Total Invoice Value <small>(In Words):</small> <span class="totalpricewords">Nill</span></td>
                                    <td class="lightpink" align="left"></td>
                                </tr>

                                <tr>
                                    <td colspan="5" align="right" class="lightgreen fontbold textsmall">Amount of Tax Subject to Reverse Charge</td>
