...
if (isset($_POST['submit']) && $_POST['submit'] == 'submit') {
    ...
    $totalClientCreated = $obj_client->get_row("select count(user_id) as totalClientCreated from " . $obj_client->getTableName('user') . " where added_by=" . $obj_client->sanitize($_SESSION['user_detail']['user_id']));
    ...
    if ($subscribePlanDetail['data']->no_of_client>=0 && ($totalClientCreated->totalClientCreated >= intval($subscribePlanDetail['data']->no_of_client))) {
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="whitebg formboxcontainer">
            <form name="client-user" id="client-user" method="POST">
                <h2 class="greyheading"><?php if (isset($_GET['id']) && isset($_GET['action']) && $_GET['action'] == "Edit ") {
            echo 'Update';
        } else {
            echo 'Add ';
        } ?>Business User</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 form-group">
                        ...
                        <input type="text" name="first_name" id="first_name" placeholder="Enter first name" class="required form-control" data-bind="content" value="<?php if (isset($_POST['first_name'])) {
            echo $_POST['first_name'];
        } else if (isset($dataArr['data']->first_name)) {
            echo $dataArr['data']->first_name;
        } ?>" />
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-12 form-group">

                        <label>Last Name<span class="starred">*</span></label>
                        <input type="text" name="last_name" id="last_name" placeholder="Enter last name" class="required form-control" data-bind="content" value="<?php if (isset($_POST['last_name'])) {
            echo $_POST['last_name'];
        } else if (isset($dataArr['data']->last_name)) {
            echo $dataArr['data']->last_name;
        } ?>" />
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 form-group">
                        ...
                        <input type="text" name="company_name" id="company_name" placeholder="Enter company name" class="required form-control" data-bind="content" value="<?php if (isset($_POST['company_name'])) {
            echo $_POST['company_name'];
        } else if (isset($dataArr['data']->company_name)) {
            echo $dataArr['data']->company_name;
        } ?>" />
                    </div>
                    <div class="clear"></div>
                    ...
                    <?php if (isset($_GET['id']) && isset($_GET['action']) && $_GET['action'] == "editClient") { ?>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 form-group">
                            ...
                            <div class="clear"></div>
                            <div class="username not-allowed"><?php if (isset($dataArr['data']->username)) {
                            echo $dataArr['data']->username;
                        } ?></div>
                        </div>
...
<?php } ?>
    ...
    echo $dataArr['data']->email;
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12 form-group">
                        ...
                        <input type="text" name="phonenumber" id="phonenumber" placeholder="Enter phone number" class="required form-control" data-bind="mobilenumber" value="<?php if (isset($_POST['phonenumber'])) {
