				...
				<div class="errorValidationContainer">
				 ...
				 <div class="row">
					...
					<div class="col-md-4 col-sm-4 col-xs-12 form-group placeofsupply">
						...
						<input type="text" placeholder="YYYY-MM-DD" readonly="true" data-bind="date" name="receipt_voucher_date" id="receipt_voucher_date" class="form-control required" value="<?php echo $invoiceData[0]->corresponding_document_date; ?>" />
					</div>
				 </div>
				 ...
				 <div class="row">
					...
					<div class="col-md-6">
						<div class="greyborder inovicedeatil">
							...
							<div class="row form-group">
								<div class="col-md-4 col-sm-3 col-xs-12 padleftnone"><label>GSTIN/UIN</label></div>
								<div class="col-md-8 col-sm-3 col-xs-12"><input type="text" placeholder="GSTIN/UIN" class="form-control" name='shipping_gstin_number' data-bind="gstin" readonly="true" id='shipping_gstin_number' value="<?php echo $invoiceData[0]->shipping_gstin_number; ?>" /></div>
							</div>
