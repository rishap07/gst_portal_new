				...
				<div class="errorValidationContainer">
				 ...
				 <div class="row">
					<div class="col-md-4 col-sm-4 col-xs-12 form-group">
						...
						<input type="text" placeholder="Invoice Serial Number" readonly="true" class="form-control required" value="<?php echo $rvInvoiceNumber; ?>" name="invoice_serial_number" id="invoice_serial_number" />
					</div>
					...
					<div class="col-md-4 col-sm-4 col-xs-12 form-group">
						...
						<input type="text" placeholder="Invoice Reference Number" class="required form-control" data-bind="content" value="<?php echo $rvInvoiceNumber; ?>" name="invoice_reference_number" id="invoice_reference_number" />
					</div>
				 </div>
