...
/*
    ...
    * 
 */
include('/home/gstkeeper/public_html/demo1/conf/config.inc.php');

if(!file_exists('/home/gstkeeper/public_html/demo1/conf/config.inc.php'))
{
...
$uWhere = " where is_deleted='0' AND (user_group = '4' or user_group='3')";
...
$uQuery = "SELECT COUNT(" . $sIndexColumn . ") as count FROM $uTable where  is_deleted='0' AND (user_group = '4' or user_group='3')";
//echo $uQuery;die;
