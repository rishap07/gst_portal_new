		...
		if(count($receiptVoucherItems) > 0) {
			...
			foreach($receiptVoucherItems as $receiptVoucherItem) {
				...
				$rv_items .= '<tr class="invoice_tr" data-row-id="'.$counter.'" id="invoice_tr_'.$counter.'">';
					...
					$rv_items .= '<td><div style="width:70px;" class="inptxt padrgt0"><i class="fa fa-inr"></i><input type="text" id="invoice_tr_'.$counter.'_originalvalue" name="invoice_originalvalue[]" readonly="true" class="readonly pricinput" value="'.$receiptVoucherItem->taxable_subtotal.'" /></div></td>';
					$rv_items .= '<td><div style="width:70px;" class="inptxt padrgt0"><i class="fa fa-inr"></i><input type="text" id="invoice_tr_'.$counter.'_taxablevalue" name="invoice_taxablevalue[]" class="validateInvoiceAmount invoiceTaxableValue pricinput required" placeholder="0.00" value="0.00" /></div></td>';
