			...
			foreach($receiptVoucherItems as $receiptVoucherItem) {
				...
				$rv_items .= '<tr class="invoice_tr" data-row-id="'.$counter.'" id="invoice_tr_'.$counter.'">';
					...
					if($result['company_state'] === $result['supply_place']) {
						...
						$rv_items .= '<td><input type="text" id="invoice_tr_'.$counter.'_cgstrate" name="invoice_cgstrate[]" class="inptxt validateDecimalValue invcgstrate" placeholder="0.00" value="'.$receiptVoucherItem->cgst_rate.'" style="width:75px;" /></td>';
						$rv_items .= '<td><div style="width:100px;" class="padrgt0"><i class="fa fa-inr"></i><input type="text" style="width:90%;" id="invoice_tr_'.$counter.'_cgstamount" name="invoice_cgstamount[]" readonly="true" class="inptxt invcgstamount" value="'.$receiptVoucherItem->cgst_amount.'" placeholder="0.00" /></div></td>';
						$rv_items .= '<td><input type="text" id="invoice_tr_'.$counter.'_sgstrate" name="invoice_sgstrate[]" class="inptxt validateDecimalValue invsgstrate" placeholder="0.00" value="'.$receiptVoucherItem->sgst_rate.'" style="width:75px;" /></td>';
						$rv_items .= '<td><div style="width:100px;" class="padrgt0"><i class="fa fa-inr"></i><input type="text" style="width:90%;" id="invoice_tr_'.$counter.'_sgstamount" name="invoice_sgstamount[]" readonly="true" class="inptxt invsgstamount" value="'.$receiptVoucherItem->sgst_amount.'" placeholder="0.00" /></div></td>';
						$rv_items .= '<td><input type="text" id="invoice_tr_'.$counter.'_igstrate" name="invoice_igstrate[]" readonly="true" class="inptxt validateDecimalValue invigstrate" placeholder="0.00" value="0.00" style="width:75px;" /></td>';
						...
						$rv_items .= '<td><input type="text" id="invoice_tr_'.$counter.'_cgstrate" name="invoice_cgstrate[]" readonly="true" class="inptxt validateDecimalValue invcgstrate" placeholder="0.00" value="0.00" style="width:75px;" /></td>';
						$rv_items .= '<td><div style="width:100px;" class="padrgt0"><i class="fa fa-inr"></i><input type="text" style="width:90%;" id="invoice_tr_'.$counter.'_cgstamount" name="invoice_cgstamount[]" readonly="true" class="inptxt invcgstamount" value="0.00" placeholder="0.00" /></div></td>';
						$rv_items .= '<td><input type="text" id="invoice_tr_'.$counter.'_sgstrate" name="invoice_sgstrate[]" readonly="true" class="inptxt validateDecimalValue invsgstrate" placeholder="0.00" value="0.00" style="width:75px;" /></td>';
						$rv_items .= '<td><div style="width:100px;" class="padrgt0"><i class="fa fa-inr"></i><input type="text" style="width:90%;" id="invoice_tr_'.$counter.'_sgstamount" name="invoice_sgstamount[]" readonly="true" class="inptxt invsgstamount" value="0.00" placeholder="0.00" /></div></td>';
						$rv_items .= '<td><input type="text" id="invoice_tr_'.$counter.'_igstrate" name="invoice_igstrate[]" class="inptxt validateDecimalValue invigstrate" placeholder="0.00" value="'.$receiptVoucherItem->igst_rate.'" style="width:75px;" /></td>';
					...
					$rv_items .= '<td><input type="text" id="invoice_tr_'.$counter.'_cessrate" name="invoice_cessrate[]" class="inptxt validateDecimalValue invcessrate" placeholder="0.00" value="'.$receiptVoucherItem->cess_rate.'" style="width:75px;" /></td><td>';
