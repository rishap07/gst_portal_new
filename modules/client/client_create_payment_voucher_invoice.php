                ...
                <div class="kycform">
                    <div class="kycmainbox invoiceform">
						...
						<div class="formcol third">
                            ...
                            <input type="text" placeholder="Invoice Reference Number" class="required" data-bind="content" value="<?php echo $pvInvoiceNumber; ?>" name="invoice_reference_number" id="invoice_reference_number" />
                        </div>
