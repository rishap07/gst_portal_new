...
if( isset($_GET['action']) && $_GET['action'] == 'deletePVInvoice' && isset($_GET['id']) && $obj_client->validateId($_GET['id'])) {
...
<div class="col-md-12 col-sm-12 col-xs-12 padrgtnone mobpadlr formcontainer">
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div>
            <a class='btn btn-default btn-success btnwidth addnew' href='<?php echo PROJECT_URL;?>/?page=client_create_payment_voucher_invoice'>Add Payment Voucher Invoice</a>
        </div>
        <h1>Payment Voucher Invoice</h1>
        <hr class="headingborder">
        <h2 class="greyheading">Payment Voucher Invoice Listing</h2>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="invoice-itemtable" id="mainTable">
                <thead>
                    <tr>
						...
						<th align='left'>Payment<br><i class="fa fa-inr"></i></th>
        ...
        return {
            init: function () {
                ...
                $('#mainTable').dataTable({
                    ...
                    "bStateSave": false,
                    "bDestroy": true,
                    "sAjaxSource": "<?php echo PROJECT_URL; ?>/?ajax=client_payment_voucher_invoice_list",
