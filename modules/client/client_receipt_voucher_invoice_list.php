...
<div class="col-md-12 col-sm-12 col-xs-12 padrgtnone mobpadlr formcontainer">
    <div class="col-md-12 col-sm-12 col-xs-12">
     <h1>Receipt Voucher Invoice</h1>
        <div class="whitebg formboxcontainer">
        <div>
            <a class='btn btn-default btn-success btnwidth addnew' href='<?php echo PROJECT_URL;?>/?page=client_create_receipt_voucher_invoice'>Add Receipt Voucher Invoice</a>
        </div>
      
     
        <h2 class="greyheading">Receipt Voucher Invoice Listing</h2>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="invoice-itemtable" id="mainTable">
                <thead>
                    <tr>
						...
						<th align='left'>Advance<br><i class="fa fa-inr"></i></th>
