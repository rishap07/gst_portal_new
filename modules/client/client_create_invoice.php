                ...
                <div class="kycform">
                    <div class="kycmainbox invoiceform">
						...
						<div class="formcol">
                            ...
                            <div class="clear"></div>
                            <input type="radio" name="invoice_type" value="taxinvoice" checked="checked" /><span class="inputtxt">General Tax</span>
							<input type="radio" name="invoice_type" value="exportinvoice" /><span class="inputtxt">Export</span>
						...
						<div class="formcol two">
                            ...
                            <div class="clear"></div>
                            <input type="radio" name="invoice_nature" value="salesinvoice" checked="checked" /><span class="inputtxt">Sales Invoice</span>
                            <input type="radio" name="invoice_nature" value="purchaseinvoice" /><span class="inputtxt">Purchase Invoice</span>
                        </div>
