				...
				<div class="row">
				 ...
				 <div class="table-responsive">
					<table width="100%" border="0" cellspacing="0" cellpadding="4" class="table invoicetable tablecontent">
						...
						<tr class="tdsamount">
							<td colspan="10" align="right" class="lightgreen fontbold textsmall tdsamountftd">Amount of Tax Subject to TDS:</td>
						...
						<tr class="tcsamount">
							<td colspan="10" align="right" class="lightgreen fontbold textsmall tcsamountftd">Amount of Tax Subject to TCS:</td>
