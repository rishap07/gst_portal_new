<?php
	...
	if( isset($_GET['action']) && $_GET['action'] == 'editDCInvoice' && isset($_GET['id']) && $obj_client->validateId($_GET['id'])) {
...
<form name="create-invoice" id="create-invoice" method="POST">
	...
	<div class="col-md-12 col-sm-12 col-xs-12 padrgtnone mobpadlr formcontainer">
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div class="col-md-12 col-sm-12 col-xs-12 heading"><h1>Delivery Challan Invoice</h1></div>
			...
			<div class="whitebg formboxcontainer">
				...
				<div class="row">
				 ...
				 <div class="row">
					<div class="col-md-4 col-sm-4 col-xs-12 form-group">
						<label>Consigner Name <span class="starred">*</span></label>
					...
					<div class="col-md-4 col-sm-4 col-xs-12 form-group">
						<label>Consigner Address <span class="starred">*</span></label>
					...
					<div class="col-md-4 col-sm-4 col-xs-12 form-group">
						<label>Consigner State <span class="starred">*</span></label>
				 ...
				 <div class="row">
					<div class="col-md-4 col-sm-4 col-xs-12 form-group">
						<label>Consigner GSTIN <span class="starred">*</span></label>
				 ...
				 <div class="row">
					<div class="col-md-4 col-sm-4 col-xs-12 form-group deliverychallantype">
						<label>Challan Type <span class="starred">*</span></label>
						<select name='delivery_challan_type' id='delivery_challan_type' class="required form-control">
							<option value=''>Select Challan Type</option>
							<option value='jobwork' <?php if($invoiceData[0]->delivery_challan_type == "jobwork") { echo 'selected="selected"'; } ?>>Job Work</option>
							<option value='supplyofliquidgas' <?php if($invoiceData[0]->delivery_challan_type == "supplyofliquidgas") { echo 'selected="selected"'; } ?>>Supply of Liquid Gas</option>
							<option value='supplyonapproval' <?php if($invoiceData[0]->delivery_challan_type == "supplyonapproval") { echo 'selected="selected"'; } ?>>Supply on Approval</option>
							<option value='others' <?php if($invoiceData[0]->delivery_challan_type == "others") { echo 'selected="selected"'; } ?>>Others</option>
						</select>
					</div>
				 ...
				 <div class="row">
					...
					<div class="col-md-6">
						<div class="greyborder inovicedeatil">
							<div class="formtitle">Consignee Detail</div>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="4" class="table invoicetable tablecontent">
						...
						<?php foreach($invoiceData as $invData) { ?>
							...
							<tr class="invoice_tr" data-row-id="<?php echo $counter; ?>" id="invoice_tr_<?php echo $counter; ?>">
								...
								<td>
									<input type="text" id="invoice_tr_<?php echo $counter; ?>_quantity" name="invoice_quantity[]" class="required validateDecimalValue invoiceQuantity inptxt" data-bind="decimal" value="<?php echo $invData->item_quantity; ?>" placeholder="Enter Quantity" style="width:100px;" />
								</td>
								<td>
						...
						<tr>
							<td colspan="18" align="right" class="lightyellow totalamount">Total Invoice Value <span>(In Figure)</span><div class="totalprice"><i class="fa fa-inr"></i><span class="invoicetotalprice"><?php echo $invoiceData[0]->invoice_total_value; ?></span></div></td>
						...
						<tr>
							<td colspan="18" align="right" class="lightpink fontbold totalamountwords" style="font-size:13px;">Total Invoice Value <small>(In Words):</small> <span class="totalpricewords"><?php echo ucwords($invoice_total_value_words); ?></span></td>
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		/* select2 js for delivery challan type */
        $("#delivery_challan_type").select2();
		...
		$("#save_add_new_invoice").click(function(){
			...
			if(flag === 1) {
				...
				$("#loading").show();
				$.ajax({
					data: {invoiceData:$("#create-invoice").serialize(), action:"saveUpdateDCInvoice"},
					dataType: 'json',
					type: 'post',
					url: "<?php echo PROJECT_URL; ?>/?ajax=client_save_update_delivery_challan_invoice",
					success: function(response){
						...
						if(response.status == "error") {
							...
							window.location.href = '<?php echo PROJECT_URL; ?>/?page=client_create_delivery_challan_invoice';
						}
					}
				});
			}
			...
			$.ajax({
                ...
                success: function(response){
                    ...
                    if(response.status == "error") {
                        ...
                        $(".errorValidationContainer").html("");
                        $(".errorValidationContainer").hide();
                        window.location.href = '<?php echo PROJECT_URL; ?>/?page=client_delivery_challan_invoice_list';
                    }
                }
            });
        });
