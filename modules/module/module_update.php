...
echo	'Update'; } else { echo 'Create New' ; } ?> Module Information</h2>
              ...
              <div class="clear"></div>
						...
						<div class="tc">
                            <input type='submit' class="btn btn-danger" name='submit' value='<?php if(isset($_GET['id']) && isset($_GET['action']) && $_GET['action'] == "editModule") { echo 'update'; } else { echo 'submit'; } ?>' id='submit'>
