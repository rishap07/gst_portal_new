...
if (count($dataTotalMonthSales) > 0) {
  ...
  for($i=0;$i < sizeof($dataTotalMonthSales); $i++) {
	  ...
	  {
		$sale=0;
		//var_dump($dataTotalMonthSale[$i]);
       // $sale =round($dataTotalMonthSale->totalsale-$dataTotalMonthSale_cr_rv->totalsale);	
      	   
        array_push($data_month_sale, array($start_year . "/" . $dataTotalMonthSale->month,$sale ));                       
	  }
  }
