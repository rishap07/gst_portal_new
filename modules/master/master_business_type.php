...
<div class="col-md-12 col-sm-12 col-xs-12 padrgtnone mobpadlr formcontainer">
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div>
            <a class='btn btn-default btn-success btnwidth addnew' href='<?php echo PROJECT_URL;?>/?page=master_business_type_update'>Add New</a>
        </div>
     <div class="clear"></div>
        ...
        <h2 class="greyheading">Business Type Listing</h2>
        ...
        return {
            init: function () {
                ...
                $('#mainTable').dataTable({
                    ...
                    "bStateSave": false,
                    "bDestroy": true,
                    "sAjaxSource": "<?php echo PROJECT_URL; ?>/?ajax=master_business_type",
