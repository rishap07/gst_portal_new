...
$aColumns = array('g.notification_id', 'g.notification_name', 'g.notification_message', 'g.vendor_list','g.start_time','g.end_time','g.status');
...
foreach($rResult as $aRow) {
    ...
    $row[] = utf8_decode($aRow->start_time);
	$row[] = utf8_decode($aRow->end_time);
